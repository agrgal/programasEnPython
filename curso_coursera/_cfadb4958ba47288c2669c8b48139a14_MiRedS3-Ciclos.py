...
while continuar:
	...
	escribir_mensaje = str(input("¿Deseas escribir un mensaje? (S/N) [M/m] para cambiar tu nombre. "))
	...
	if escribir_mensaje == "S" or escribir_mensaje == "s" or escribir_mensaje == "":
		...
		continuar = False
	elif (escribir_mensaje == "M" or escribir_mensaje == "m"):
		nombre = input("¿Cuál es el nuevo nombre que quieres usar? ")
		print()
		print("--------------------------------------------------")
		print("Tu nuevo nombre es: ",nombre)
		print("--------------------------------------------------")
	else:
		print("Opción no válida. Elige una opción válida [S/N/M]. ")
