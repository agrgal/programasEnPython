...
def obtener_genero():
	genero = ""
	while genero!="H" and genero!="h" and genero!="M" and genero!="m":
		genero = input("Dime si eres hombre o mujer [H/M]. ")
	return genero
	
def obtener_pais():
	pais = input("Dime tu pais de nacimiento. ")
	return pais		


def mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos,paisNac,genero):
    print("--------------------------------------------------")
    print("Nombre:   ", nombre)
    print("Edad:     ", edad, "años")
    print("Estatura: ", estatura_m, "m y ", estatura_cm, "centímetros")
    print("Amigos:   ", num_amigos)
    print("País de nacimiento:   ", paisNac)
    print("Género:   ", genero)
    print("--------------------------------------------------")
...
mostrar_bienvenida()
(nombre,edad,estatura_m,estatura_cm,num_amigos)=obtener_datos("","","","","")
# nombre = obtener_nombre()
print()
...
# num_amigos = obtener_num_amigos()
paisNac = obtener_pais()
genero = obtener_genero()
print("Muy bien,", nombre, ". Entonces podemos crear un perfil con estos datos.")
mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos,paisNac,genero)
