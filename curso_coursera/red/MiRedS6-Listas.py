...
while opcion != 0:
	...
	if opcion == 1:
		...
		Red.mostrar_perfil(nombre, edad, estatura_m, estatura_cm, sexo, pais, amigos)
	elif opcion == 5: #Opción agregada para añadir un amigo a la lista
		amigos = Red.agregar_amigo(amigos)
	elif opcion == 6: #Opción agregada para ver los últimos mensajes de mis amigos
		ultimos = Red.ultimos_estados(nombre,amigos)
		print("================================================")
		for i in ultimos:
			parejas = i.split(":")
			print("Mi amigo",parejas[0],"dijo:",parejas[1])	
		print("================================================")
	elif opcion == 4:
		edad = Red.obtener_edad()
		(estatura_m, estatura_cm) = Red.obtener_estatura()
