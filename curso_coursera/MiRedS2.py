...
#Quinta interacción. Género
sexo = input("¿Eres de sexo masculino o Femenino? Contesta con una M o una F.")
print()

#Sexta interacción. Ciudad
ciudadNacimiento = input("Dime tu ciudad de nacimiento. ")
print()

#Séptima interacción. País
...
print("Sexo:  ", sexo)
print("Ciudad de nacimiento:  ", ciudadNacimiento)
print("Amigos:  ", pais)
print("--------------------------------------------------")
