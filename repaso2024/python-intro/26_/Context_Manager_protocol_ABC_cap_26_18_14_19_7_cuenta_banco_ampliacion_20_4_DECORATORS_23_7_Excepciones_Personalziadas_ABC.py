...
class Cuenta(metaclass=ABCMeta):
    ...
    def balance(self):
        """ BALANCE: propiedad que es capaz de almacenar el balance de una cuenta.
         Sin setter. solo READ-ONLY. La he puesto como clase ABC luego todas las subclases
         deberán tener este método-propiedad"""
        pass
