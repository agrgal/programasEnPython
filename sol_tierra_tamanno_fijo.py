...
limiteenx = 8000 # o -ejex*1.1
limiteeny = 8000 # o -ejey*1.1
ax.set_xlim(-limiteenx,limiteenx)
ax.set_ylim(-limiteeny,limiteeny) #límites algo separados.
...
sol = plt.Circle( xy=punto, radius=limiteenx*0.1) 
...
tierra = plt.Circle(xy=(2*ejex,2*ejey) , radius=0.05*limiteenx) 
